...
awakeIntoGroupsVoid(data,"status", f)
for newStatus in newStatusList:
  awakeIntoGroupsVoid(data, newStatus, f)
f.write("\n")

for newStatus in newStatusList:
  calculateDifferenceColumns(data, "status", newStatus)
f.write("\n")
